...
class ListInfinitySaga extends State<InfinitySaga>{
  Future<List<InfinityComic>> _getComics() async{
    ...
    var md5D = generateMd5(now.toString()+"fb09662abb26d8f50e4bb7ee233611f32f53b031"+"1d42178ec47fd1112556913bcc07f3e7");
    var url = "https://gateway.marvel.com:443/v1/public/characters?&ts=" + now.toString()+  "&apikey=1d42178ec47fd1112556913bcc07f3e7&hash="+md5D;
    print(url);
